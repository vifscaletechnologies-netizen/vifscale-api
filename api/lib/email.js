...
const TEMPLATES = {
  TIER_1: parseInt(process.env.BREVO_TEMPLATE_0_25 || '10'),    // 0-25%: Activity Without System
  TIER_2: parseInt(process.env.BREVO_TEMPLATE_26_50 || '32'),   // 26-50%: Fragmented Infrastructure
  ...
  TIER_5: parseInt(process.env.BREVO_TEMPLATE_86_100 || '13')   // 86-100%: Operational Revenue Engine
};
